...
export function ProjectActionButtons({
  ...
  async function handleDelete() {
    if (confirmInput !== projectName) return;
          ...
          <div className="relative z-10 w-full max-w-md bg-surface-container ghost shadow-2xl animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="p-6 space-y-5">
              <p className="text-sm text-on-surface-variant leading-relaxed">
                ...
                will permanently remove all tasks, comments, run history, and
                agent assignments associated with this project.
              </p>
              ...
              <div className="bg-error/6 border border-error/20 rounded-sm px-4 py-3 flex items-start gap-3">
                ...
                <p className="text-xs text-error/80 leading-relaxed">
                  All agents assigned to this project will be unlinked. Active
                  runs will be terminated immediately.
                </p>
              </div>
            ...
            <div className="flex items-center justify-between px-6 pb-6">
              ...
              <button
                ...
                disabled={confirmInput !== projectName || isDeleting}
